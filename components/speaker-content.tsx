...
const allSpeakers: Speaker[] = [
  ...
  },
  {
    ...
    background: "Senior Staff Software Engineer at Google, author of 'Deep Learning with Python'.",
    year: "2024-2025",
  },
  {
    name: "Nicholas Carlini",
    role: "Research Scientist, Google DeepMind",
    background: "Expert in adversarial machine learning and security.",
    year: "2024-2025",
  },
  {
    name: "Evan Hubinger",
    role: "Research Scientist, Anthropic",
    background: "Focuses on inner alignment and safety.",
    year: "2024-2025",
  },
  {
    name: "Will Bryk",
    role: "Researcher",
    background: "Working on reasoning and alignment.",
    year: "2024-2025",
  },
  {
    name: "Demi Guo",
    role: "PhD Student, Stanford",
    background: "Researching efficient and reliable machine learning.",
    year: "2024-2025",
  },
];
