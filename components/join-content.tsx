...
export default function JoinContent() {
  return (
    ...
    >
      <h5 className="text-lg md:text-2xl text-white/60 max-w-2xl ">
      ...
      >
        <div className=" bg-transparent bg-linear-to-b from-[#ac1515]/60 to-[#ac1515]/10 flex items-center justify-center rounded-full group-hover:-translate-y-px transition-all duration-200 shadow-lg hover:shadow-2xl py-4 px-8 md:px-16 inset-shadow-sm inset-shadow-white/30 font-medium tracking-tight text-white text-2xl md:text-4xl active:scale-95 hover:bg-[#ac1515]/30">
          Get on the list
        </div>
      </motion.a>
    </motion.div>
